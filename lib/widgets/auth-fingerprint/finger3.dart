import 'package:clean_reso_coder_implementation/widgets/auth-fingerprint/pin_screen.dart';
import 'package:clean_reso_coder_implementation/widgets/auth-fingerprint/pin_utils.dart';
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                     /*  Navigator.of(context).push(MaterialPageRoute(
                          ...
                          PinUtils(context).showPinDialogWithConfirmation();
                    },
                    /*  onPressed: () => screenLockCreate(
                      // cancelButton: ElevatedButton(onPressed: (){}, child: Text('cancelllllllll')),
                      title: Text(
                          'لطفا یک رمز عددی برای کیف توکن خود انتخاب کنید'),
                      canCancel: true,
                      context: context,
                      confirmTitle: Text('لطفا مجددا رمز را وار کنید'),
